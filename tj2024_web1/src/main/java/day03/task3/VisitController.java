...
public class VisitController extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 1. HTTP로 부터 요청 받은 HTTP HEADER BODY(본문) 를 DTO 피싱(변환) 가져오기.
		...
		resp.setContentType( "application/json" );	// (1) 응답할 자료틩 타입 명시
	...
	// 매개변수 : X	
	// 반환타입 : application/json		, 매개변수 예] [ { "num" : 1 , "content":"안녕1" , "age" : 40 } , { "num2" : 2 , "content":"안녕2" , "age" : 30 } ]
	@Override
	...
	// 4. 방문록 삭제		: DELETE	, url : http://localhost:8080/tj2024b_web1/day03/visit2
