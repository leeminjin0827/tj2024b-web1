...
public class Example1 extends HttpServlet{
	...
	// 1. 쿼리스트링 예] 
	// http get url : http://localhost:8080/tj2024_web1/day04/example1?value1=임의값&value2=임의값
	@Override
	...
	// 2. HTTP header body(본문) 예] http post url : http://localhost:8080/tj2024_web1/day04/example1
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.setContentType("application/json"); // DTO는 JSON 으로 자동 변환할 수 있다.
		resp.getWriter().print( jsonResult ); // 변환한 문자열(JSON) 변환
	} // f end
