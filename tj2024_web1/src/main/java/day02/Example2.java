...
public class Example2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 쿼리스트링의 매개변수를 가져오기
			// http://localhost:8080/tj2024_web1/day02/example2?name=강호동
			// .getParameter("URL경로상의매개변수명");	// 배개변수명의 값 (String타입) 반환 함수 , 없으면 NULL ,
		System.out.print(" 1] URL ? 뒤에 'name' 이라는 매개변수명 가진 변수의 값 가져오기 : ");
